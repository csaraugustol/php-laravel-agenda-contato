                        ...
                        <form id="addCampos" method="POST" action="{{ route('contato.store') }}">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-12 mt-2">
                                    <input type="text" class="form-control" value="{{ old('nome') }}" required placeholder="Nome"
                                        id="" name="nome" />
                                </div>
                                <div class="col-sm-12 mt-2">
                            ...
                            <div class="row form-group" id="eventoNovoTel">
                                <div class="col-lg-6 col-sm-6 mt-2">
                                    <input type="text" class="form-control" required placeholder="Telefone" id="telefone"
                                        name="telefone[]" />
                                </div>
                            </div>
