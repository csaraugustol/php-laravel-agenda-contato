                    ...
                    <div id="eventoNovoEnd">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 mt-2">
                          <input type="text" class="form-control" placeholder="Endereço" value="" name="endereco[]" id="endereco" />
                        </div>

                        <div class="col-lg-3 col-md-3 col-sm-3 mt-2">
                          <input type="text" class="form-control" placeholder="Bairro" value="" name="bairro[]" id="bairro" />
                        </div>
                      </div>
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                          <input type="text" class="form-control" placeholder="Cidade" value="" name="cidade[]" id="cidade" />
                        </div>
                  
                        <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                          <input type="text" class="form-control" placeholder="UF" value="" name="uf[]" id="uf" />
                        </div>
...
$( "#novoTel" ).click(function() {
  $( "#eventoNovoTel" ).append( '<div class="col-lg-6 col-md-6 col-sm-6 mt-2"><input type="text" class="form-control" placeholder="Telefone" id="" name="telefone[]"/></div>');
});
...
$( "#novoEnd" ).click(function() {
  cont++;
  $( "#eventoNovoEnd" ).append( '<div class="row form-group"><div class="col-lg-3 col-sm-3 mt-2"><input type="text" class="form-control" placeholder="CEP" value="" name="cep[]" id="cep'+cont+'" onblur="getDadosEndPorCEP2('+cont+')"/></div>'+ 
